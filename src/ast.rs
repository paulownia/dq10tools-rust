...
mod tests {
    ...
    fn test_from_datetime_jst1() {
        ...
        let ast = super::from_datetime(dt.to_utc()).unwrap();
    ...
    fn test_from_datetime_jst4() {
        ...
        let ast = super::from_datetime(jst.to_utc()).unwrap();
        assert_eq!(ast.time().hour(), 21);
        assert_eq!(ast.time().minute(), 5);
    }
    #[test]
    ...
    fn test_from_datetime_sst1() {
        ...
        let ast = super::from_datetime(sst.to_utc()).unwrap();
        assert_eq!(ast.time().hour(), 0);
        assert_eq!(ast.time().minute(), 0);
    }
    #[test]
    ...
    fn test_same_from_timestamp_and_local_now() {
        ...
        let ast2 = super::from_datetime(l.to_utc()).unwrap();
        assert_eq!(ast1, ast2)
    }
    #[test]
    fn test_same_utc_now_and_local_now() {
        ...
        let ast1 = super::from_datetime(l.to_utc()).unwrap();
